...
namespace ClarionApp
{
    public class WSProxy:IDisposable
    {
        ...
        /// </summary>
        /// <param name="creatureId">The creature ID</param>
        /// <param name="thingName">The thing that will be stacked</param>
        /// <exception cref="WorldServerConnectionError">Connection Exception</exception>
        /// <exception cref="WorldServerReadError">Read Exception</exception>
        /// <exception cref="WorldServerSendError">Send Exception</exception>
        /// <returns>The messages received from World Server</returns>
		...
		/// </summary>
		/// <param name="creatureId">The creature ID</param>
		/// <param name="thingName">The thing that will be hided</param>
		/// <exception cref="WorldServerConnectionError">Connection Exception</exception>
		/// <exception cref="WorldServerReadError">Read Exception</exception>
		/// <exception cref="WorldServerSendError">Send Exception</exception>
		/// <returns>The messages received from World Server</returns>
		...
		/// <summary>
		/// Send DeliverLeaflet Command
		/// </summary>
		/// <exception cref="WorldServerConnectionError">Connection Exception</exception>
		/// <exception cref="WorldServerReadError">Read Exception</exception>
		/// <exception cref="WorldServerSendError">Send Exception</exception>
		/// <returns>The messages received from World Server</returns>
		public Sack SendDeliverLeaflet (string creatureId, string leafletId)
		{
		...
		/// <summary>
		/// Create a new DeliverySpot
		/// </summary>
		/// <param name="type">DeliverySpot type</param>
		/// <param name="x">X1 Position</param>
		/// <param name="y">Y1 Position</param>
		/// <returns>DeliverySpot's name</returns>
		public String NewDeliverySpot (Int32 type, Int32 x, Int32 y)
		{
			...
			try {
				...
				if (!String.IsNullOrWhiteSpace (response)) {
					string [] tokens = response.Split (new char [] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
					dsName = (tokens != null && tokens.Length > 1) ? tokens [1] : null;
				}
