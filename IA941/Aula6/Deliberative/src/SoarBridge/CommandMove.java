...
public class CommandMove
{
    ...
    public String getParams(){
       ...
       builder.append(", Linear Velocity: ").append(getLinearVelocity());
       builder.append(", Right Velocity: ").append(getRightVelocity());
       builder.append(", Left Velocity: ").append(getLeftVelocity());
